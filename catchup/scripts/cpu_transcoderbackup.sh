...
ffmpeg -i "$INPUT_STREAM" -preset superfast -tune zerolatency -g 48 -sc_threshold 0 -keyint_min 48 -r 30 \
...
-map "[v720]" -c:v libx264 -b:v 1500k -maxrate 1600k -bufsize 2000k -map a:0 -c:a aac -b:a 96k -f hls -hls_time $SEGMENT_TIME -hls_flags delete_segments "$OUTPUT_DIR/720p.m3u8"
